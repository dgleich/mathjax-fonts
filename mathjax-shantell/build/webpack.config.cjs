...
module.exports = {
  name: 'tex-mml-svg-mathjax-shantell',
  entry: path.resolve(__dirname, 'tex-mml-svg-mathjax-shantell.js'),
  output: { path: path.resolve(__dirname, '..'), filename: 'tex-mml-svg-mathjax-shantell.js' },
  target: ['web', 'es5'],
  plugins: [
