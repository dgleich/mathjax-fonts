...
module.exports = {
  name: 'tex-mml-svg-mathjax-shantell-nosre',
  entry: path.resolve(__dirname, 'tex-mml-svg-mathjax-shantell-nosre.js'),
  output: { path: path.resolve(__dirname, '..'), filename: 'tex-mml-svg-mathjax-shantell-nosre.js' },
  target: ['web', 'es5'],
  plugins: [
