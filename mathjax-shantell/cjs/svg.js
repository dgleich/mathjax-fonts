...
var Base = (0, common_js_1.CommonMathJaxShantellMixin)(FontData_js_1.SvgFontData);
var MathJaxShantell = (function (_super) {
    __extends(MathJaxShantell, _super);
    function MathJaxShantell(options) {
        var e_1, _a;
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'SHANTELL-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxShantell.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-shantell-font/js/svg/dynamic' });
    ...
    MathJaxShantell.variantCacheIds = {
        'normal': 'N',
        'bold': 'B',
        'italic': 'I',
        'bold-italic': 'BI',
