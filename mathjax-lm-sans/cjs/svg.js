...
var Base = (0, common_js_1.CommonMathJaxLMSansMixin)(FontData_js_1.SvgFontData);
var MathJaxLMSans = (function (_super) {
    __extends(MathJaxLMSans, _super);
    function MathJaxLMSans(options) {
        var e_1, _a;
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'LMSANS-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxLMSans.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-lm-sans-font/js/svg/dynamic' });
