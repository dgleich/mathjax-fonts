...
var MathJaxLato = (function (_super) {
    ...
    function MathJaxLato(options) {
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'LATO-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxLato.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-lato-font/js/svg/dynamic' });
