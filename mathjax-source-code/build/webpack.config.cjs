...
module.exports = {
  name: 'tex-mml-svg-mathjax-source-code',
  entry: path.resolve(__dirname, 'tex-mml-svg-mathjax-source-code.js'),
  output: { path: path.resolve(__dirname, '..'), filename: 'tex-mml-svg-mathjax-source-code.js' },
  target: ['web', 'es5'],
  plugins: [
