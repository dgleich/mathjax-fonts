...
module.exports = {
  name: 'tex-mml-svg-mathjax-source-code-nosre',
  entry: path.resolve(__dirname, 'tex-mml-svg-mathjax-source-code-nosre.js'),
  output: { path: path.resolve(__dirname, '..'), filename: 'tex-mml-svg-mathjax-source-code-nosre.js' },
  target: ['web', 'es5'],
  plugins: [
