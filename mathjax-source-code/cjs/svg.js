...
var MathJaxSourceCode = (function (_super) {
    ...
    function MathJaxSourceCode(options) {
        var e_1, _a;
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'SRCCODE-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxSourceCode.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-source-code-font/js/svg/dynamic' });
