...
module.exports = {
  name: 'tex-mml-svg-mathjax-source-sans-nosre',
  entry: path.resolve(__dirname, 'tex-mml-svg-mathjax-source-sans-nosre.js'),
  output: { path: path.resolve(__dirname, '..'), filename: 'tex-mml-svg-mathjax-source-sans-nosre.js' },
  target: ['web', 'es5'],
  plugins: [
