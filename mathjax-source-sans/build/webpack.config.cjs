...
module.exports = {
  name: 'tex-mml-svg-mathjax-source-sans',
  entry: path.resolve(__dirname, 'tex-mml-svg-mathjax-source-sans.js'),
  output: { path: path.resolve(__dirname, '..'), filename: 'tex-mml-svg-mathjax-source-sans.js' },
  target: ['web', 'es5'],
  plugins: [
