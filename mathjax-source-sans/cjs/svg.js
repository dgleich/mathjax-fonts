...
var Base = (0, common_js_1.CommonMathJaxSourceSansMixin)(FontData_js_1.SvgFontData);
var MathJaxSourceSans = (function (_super) {
    __extends(MathJaxSourceSans, _super);
    function MathJaxSourceSans(options) {
        var e_1, _a;
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'SRCSANS-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxSourceSans.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-source-sans-font/js/svg/dynamic' });
    ...
    MathJaxSourceSans.variantCacheIds = {
        'normal': 'N',
        'bold': 'B',
        'italic': 'I',
        'bold-italic': 'BI',
