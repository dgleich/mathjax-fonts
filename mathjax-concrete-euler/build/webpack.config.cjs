...
module.exports = {
  name: 'tex-mml-svg-mathjax-concrete-euler',
  entry: path.resolve(__dirname, 'tex-mml-svg-mathjax-concrete-euler.js'),
  output: { path: path.resolve(__dirname, '..'), filename: 'tex-mml-svg-mathjax-concrete-euler.js' },
  target: ['web', 'es5'],
  plugins: [
