...
var Base = (0, common_js_1.CommonMathJaxConcreteEulerMixin)(FontData_js_1.SvgFontData);
var MathJaxConcreteEuler = (function (_super) {
    __extends(MathJaxConcreteEuler, _super);
    function MathJaxConcreteEuler(options) {
        var e_1, _a;
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'CONCRETE-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxConcreteEuler.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-concrete-euler-font/js/svg/dynamic' });
    ...
    MathJaxConcreteEuler.variantCacheIds = {
        'normal': 'N',
        'bold': 'B',
        'italic': 'I',
        'bold-italic': 'BI',
