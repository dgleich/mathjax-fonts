...
var Base = (0, common_js_1.CommonMathJaxNotoSansMixin)(FontData_js_1.SvgFontData);
var MathJaxNotoSans = (function (_super) {
    __extends(MathJaxNotoSans, _super);
    function MathJaxNotoSans(options) {
        var e_1, _a;
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'NOTO-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxNotoSans.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-noto-sans-font/js/svg/dynamic' });
    ...
    MathJaxNotoSans.variantCacheIds = {
        'normal': 'N',
        'bold': 'B',
        'italic': 'I',
        'bold-italic': 'BI',
