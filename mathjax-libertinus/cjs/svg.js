...
var Base = (0, common_js_1.CommonMathJaxLibertinusMixin)(FontData_js_1.SvgFontData);
var MathJaxLibertinus = (function (_super) {
    __extends(MathJaxLibertinus, _super);
    function MathJaxLibertinus(options) {
        var e_1, _a;
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'LIBERT-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxLibertinus.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-libertinus-font/js/svg/dynamic' });
    ...
    MathJaxLibertinus.variantCacheIds = {
        'normal': 'N',
        'bold': 'B',
        'italic': 'I',
        'bold-italic': 'BI',
