...
var Base = (0, common_js_1.CommonMathJaxPTSansMixin)(FontData_js_1.SvgFontData);
var MathJaxPTSans = (function (_super) {
    __extends(MathJaxPTSans, _super);
    function MathJaxPTSans(options) {
        var e_1, _a;
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'PTSANS-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxPTSans.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-ptsans-font/js/svg/dynamic' });
