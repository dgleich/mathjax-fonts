...
module.exports = {
  name: 'tex-mml-svg-mathjax-ptsans-nosre',
  entry: path.resolve(__dirname, 'tex-mml-svg-mathjax-ptsans-nosre.js'),
  output: { path: path.resolve(__dirname, '..'), filename: 'tex-mml-svg-mathjax-ptsans-nosre.js' },
  target: ['web', 'es5'],
  plugins: [
