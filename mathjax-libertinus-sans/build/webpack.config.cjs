...
module.exports = {
  name: 'tex-mml-svg-mathjax-libertinus-sans',
  entry: path.resolve(__dirname, 'tex-mml-svg-mathjax-libertinus-sans.js'),
  output: { path: path.resolve(__dirname, '..'), filename: 'tex-mml-svg-mathjax-libertinus-sans.js' },
  target: ['web', 'es5'],
  plugins: [
